...
public class ArrCharOps {
    public static void main(String[] args) {
        ...
        char[] empty_arr = {};
        arr1 = "You are a wizard Harry.".toCharArray();

        boolean test6 = ArrCharOps.lastIndexOf(arr1, 'r') == 20;
        System.out.println(ArrCharOps.lastIndexOf(arr1, 'r'));
    ...
    public static char[] concat(char[] arr1, char[] arr2) {
        char[] concatanated = new char[arr1.length + arr2.length];
        for (int i = 0; i < arr1.length; i++) {
            concatanated[i] = arr1[i];
        }
        for (int i = arr1.length; i < concatanated.length; i++) {
            concatanated[i] = arr2[i - arr1.length];
        }
        return concatanated;
    }
